...
function ParkSvg() {
  return (
    <svg viewBox="0 0 300 225" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="268" y="60" fill="white" fontSize="7" fontFamily="monospace">N</text>
    </svg>
  );
}
...
function GardenSvg() {
  return (
    <svg viewBox="0 0 300 225" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="115" y="62" fill="white" fontSize="7" fontFamily="monospace">DOM</text>
      {/* terrace arc */}
      ...
      <text x="42" y="155" fill="white" fontSize="6" fontFamily="monospace">ZIOŁA</text>
      {/* fountain */}
...
export default function ProjectCard({ project, index }: Props) {
  ...
  return (
    <div
      ref={ref}
      className={`${styles.card} ${visible ? styles.visible : ""} ${isReversed ? styles.reversed : ""}`}
    >
      ...
      <div className={styles.info}>
        <h2 className={styles.title}>
          {renderTitle(project.title, project.titleItalic)}
        </h2>
